	...
	public:
		...
		auto Menu() -> void {
			...
			ImGui::Begin(skCrypt(""), (bool*)true, window_flags);
			{
				...
				colors[ImGuiCol_Text] = ImColor(0, 150, 255);
				...
				ImGui::BeginGroup();
				{
					...
					ImGui::SameLine();
					if (Custom1337::tab2(skCrypt("ESP"), tab == 2)) tab = 2;
					ImGui::PopStyleVar();
				}
				ImGui::EndGroup();
				...
				if (tab == 0)
				{
					...
					ImGui::BeginChild(("Aimbot"), { 450 / 2 - 15, 325 });
					{
					...
					ImGui::SetCursorPos({ 265, 85 });
					ImGui::BeginChild(("Settings"), { 470 / 2 - 15, 330 });
					{
						ImGui::SetCursorPos({ 10, 15 });
						ImGui::BeginGroup();
						{
				...
				{
					ImGui::SetCursorPos({ 20, 85 });
					ImGui::BeginChild(("Visualso"), { 450 / 2 - 20, 325 });
					{
						ImGui::SetCursorPos({ 10, 15 });
						ImGui::BeginGroup();
						{
							...
							Custom1337::Checkbox(("Skeletons"), &globals->skeleton);
					...
					ImGui::SetCursorPos({ 265, 85 });
					ImGui::BeginChild(("Settingso"), { 450 / 2 - 15, 325 });
					{
						ImGui::SetCursorPos({ 10, 15 });
						ImGui::BeginGroup();
						{
							Custom1337::Checkbox(("Box Outline"), &globals->outlinebox);
		...
		auto Draw() -> void {			
			...
			if (globals->render_field_of_view) {
				...
				{
					ImGui::GetForegroundDrawList()->AddCircle(ImVec2(globals->width / 2, globals->height / 2), globals->field_of_view, ImColor(PlayerColor::accentcolor[0], PlayerColor::accentcolor[1], PlayerColor::accentcolor[2], 1.0f), 60, 1); 
				}
			}
			...
			ImGui::GetBackgroundDrawList()->AddText(ImVec2(35, 45), Watermarko, ("HARMONY.CC | FPS: " + std::to_string(static_cast<int>(fps))).c_str());
